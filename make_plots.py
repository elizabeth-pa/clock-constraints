...
#plt.grid()
plt.savefig("DE-Me-vs-M.png", dpi = dpi_setting)
#plt.show()
plt.clf()
...
plt.tick_params(direction = "in")
#plt.grid()
plt.savefig("DE-Meff-vs-w.png", dpi = dpi_setting)
#plt.show()
plt.clf()
...
plt.tick_params(direction = "in")
plt.grid()
plt.savefig("MG-gen-Meff-vs-Lambda.png", dpi = dpi_setting)
#plt.show()
plt.clf()
...
plt.tick_params(direction = "in")
#plt.grid()
plt.savefig("MG-gen-alpha-vs-beta.png", dpi=dpi_setting)
#plt.show()
plt.clf()
...
plt.savefig("MG-gal-M-vs-Lambda.png", dpi = dpi_setting)
#plt.show()
plt.clf()
...
#plt.legend(loc='lower right')
#plt.grid()
plt.savefig("DM-M-vs-m.png", dpi = dpi_setting)
#plt.show()
#plt.clf()
